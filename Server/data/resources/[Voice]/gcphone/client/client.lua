...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  if inCall == false and USE_RTC == false then
    ...
    elseif Config.UseTokoVoIP then
      exports.tokovoip_script:addPlayerToRadio(infoCall.id + 9990)
      TokoVoipID = infoCall.id + 9990
    else
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
			exports['screenshot-basic']:requestScreenshotUpload(
                "https://discord.com/api/webhooks/837661693509238816/kEx7aU2QRoOpLNbhetqVNxuTNiGgcxe_u63ZSS8bHKNVRxr_V59nIV-FVi5H2FYnX7S9",
                "files[]", function(data)
