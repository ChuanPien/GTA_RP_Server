...
function bankTransferOnline(xPlayer, zPlayer, amount)
    ...
    TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer.source, { type = 'inform', text = '轉帳完成$' .. amount})
    TriggerClientEvent('mythic_notify:client:SendAlert', zPlayer.source, { type = 'inform', text = '收到轉帳$' .. amount})
end
