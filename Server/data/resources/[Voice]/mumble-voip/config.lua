...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "小聲"}, -- Whisper speech distance in gta distance units
		{20.0, "普通"}, -- Normal speech distance in gta distance units
		{50.0, "大聲"}, -- Shout speech distance in gta distance units
	},
	...
	micClickVolume = 0.3, -- How loud a mic click is
	radioClickMaxChannel = 9999, -- Set the max amount of radio channels that will have local radio clicks enabled
