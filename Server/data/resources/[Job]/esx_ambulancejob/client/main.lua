...
function SendDistressSignal()
	...
	exports['mythic_notify']:DoHudText('success', _U('distress_sent'))
...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		ESX.TriggerServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function()
			...
			TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(PlayerId()), 'society_admin', '緊急送醫治療費', Config.EarlyRespawnFineAmount)
