...
function SendDistressSignal()
	...
	ESX.ShowNotification("Mensagem recebida")

    TriggerServerEvent('esx_addons_gcphone:startCall', 'cozinheiro', "Mensagem recebida", PlayerCoords, {
...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'cozinheiro' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenCloakroomMenu()
  ...
  local elements = {
    { label = "便服",     value = 'citizen_wear'},
    { label = "工作服",    value = 'barman_outfit'}
  }
...
function OpenVaultMenu()
    ...
    local elements = {
      {label = "----------食物----------", value = '0'},
      {label = "雞蛋 - $80", 		value = 'ovo'},
      {label = "麵包 - $80", 		value = 'bread'},
      {label = "大蒜 - $50", 		value = 'alho'},
	    {label = "香腸 - $150",     	value = 'sausage'},
      {label = "蔬菜 - $50", 		value = 'alface'},
      {label = "番茄 - $50", 		value = 'tomate'},
      {label = "香料 - $80", 		value = 'oregaos'},
      {label = "起司 - $80", 		value = 'queijo'},
      {label = "黃油 - $50",		value = 'manteiga'},
      {label = "洋蔥 - $50",		value = 'onion'},
      {label = "地瓜粉 - $50",		value = 'squash'},
      {label = "火腿 - $50",		value = 'hen'},
      {label = "筍絲 - $100",		value = 'bamboo'},
	    {label = "----------飲料----------", value = '0'},
	    {label = "礦泉水 - $150",    	value = 'water'},
      {label = "水果相撲 - $150",	value = 'jusfruit'},
      {label = "冰茶 - $150",   	value = 'icetea'},
      {label = "能量飲料 - $300",   value = 'energy'},
      {label = "檸檬汽水 - $200", 	value = 'limonade'},
      {label = "純喫茶 - $350", 	value = 'tea'},
	    {label = "----------零食----------", value = '0'},
	    {label = "花生 - $100",		value = 'bolcacahuetes'},
      {label = "鹹花生 - $100",  	value = 'bolnoixcajou'},
      {label = "開心果 - $100",   	value = 'bolpistache'},
      {label = "炸薯條 - $150",     value = 'bolchips'},
      {label = "葡萄 - $100",  		value = 'grapperaisin'},
	    {label = "冰塊 - $100",      	value = 'ice'},
      {label = "薄荷 - $100",   	value = 'menthe'},
      {label = "栗子 - $50",   	value = 'chestnut'},
	    {label = "----------酒品----------", value = '0'},
	    {label = "野格 - $450", 		value = 'jager'},
      {label = "朗姆 - $450",   	value = 'rhum'},
      {label = "威士忌 - $450",    	value = 'whisky'},
      {label = "龍舌蘭 - $450", 	value = 'tequila'},
      {label = "馬丁尼 - $450", 	value = 'martini'},
      {label = "伏特加 - $450", 	value = 'vodka'}
    }
    ...
    ESX.UI.Menu.Open(
	  ...
	  local valor = 0
		...
		if data.current.value == "alho" or "manteiga" or "tomate" or "alface" or "squash" or "onion" or "hen" or "chestnut" then
			valor = 50
		end
		
		if data.current.value == "ovo" or "oregaos"or "queijo" or "bread" then
			valor = 80
		end
		
		if data.current.value == "bolpistache" or "grapperaisin" or "ice" or "menthe" or "bolcacahuetes" or "bolnoixcajou" or "bamboo" then
			valor = 100
		end
		
		if data.current.value == "saucisson" or "water" or "jusfruit" or "icetea" or "bolchips" or "milk" then
			valor = 150
		end
		
		if data.current.value == "soda" or "limonade" then
			valor = 200
		end
		
		if data.current.value == "energy" then
			valor = 300
    end
    
    if data.current.value == "tea" then
			valor = 350
		end
		
		if data.current.value == "meat" or "rhum" or "whisky" or "tequila" or "martini" or "jager" or "vodka" then
			valor = 450
		end
		
		if data.current.value == "polvo" then
			valor = 800
		end
		
		TriggerServerEvent('esx_cozinheirojob:shop', data.current.value, valor)
      end,
...
function OpenCozinharMenu()
	...
	local elements = {
      {label = "煎雞蛋", value = 'ovoes'},
	    {label = "漢堡", value = 'burger'},
      {label = "章魚燒", value = 'polvo'},
      {label = "烤牛肉", value = 'meat'},
      {label = "炸雞排", value = 'friedchicken'},
      {label = "蛋黃派炸龍蝦", value = 'friedlobster'},
      {label = "青花魚漢堡排", value = 'friedfish'},
      {label = "奶油蒜香蝦", value = 'friedshrimp'},
      {label = "蚵仔煎", value = 'friedoyster2'},
      {label = "龍捲魚翅香腸", value = 'friedsausage'},
      {label = "炭火烤鹿肉", value = 'friedvenison'}
    }
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_cozinheirojob:craftingCoktails', data.current.value)
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'cozinheiro', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cozinheiro_actions',
    {
      title    = "餐廳收據",
      align    = 'top-left',
      elements = elements
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        menu.close()
        if amount == nil then
            exports['mythic_notify']:DoHudText('error', '錯誤數量')
            -- ESX.ShowNotification(_U('amount_invalid'))
        else
			    TriggerServerEvent('esx_cozinheirojob:Billing', amount, player)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_cozinheirojob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cozinheirojob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_cozinheirojob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cozinheirojob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_cozinheirojob:getFridgeStockItems', function(items)
    ...
    ESX.UI.Menu.Open(
      ...
      {
        title    = _U('cozinheiro_fridge_stock'),
        elements = elements
      },
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cozinheirojob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cozinheirojob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_cozinheirojob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_cozinheirojob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_cozinheirojob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'cozinheiro_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_cozinheirojob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_cozinheirojob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_cozinheirojob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_cozinheirojob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_cozinheirojob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'cozinheiro', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'cozinheiro')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'cozinheiro', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cozinheiro_actions') then
...
AddEventHandler('esx_cozinheirojob:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_cozinheirojob:teleportMarkers', position)
        end
