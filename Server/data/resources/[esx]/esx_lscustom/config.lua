...
function GetNeons()
	local neons = {
		...
		{label = _U('slate_gray'),		r = 112, 	g = 128, 	b = 144},
		{label = _U('blue'),			r = 0, 		g = 0, 		b = 255},
		{label = _U('light_blue'),		r = 0, 		g = 150, 	b = 255},
		{label = _U('navy_blue'), 		r = 0, 		g = 0, 		b = 128},
		{label = _U('sky_blue'), 		r = 135, 	g = 206, 	b = 235},
		{label = _U('turquoise'), 		r = 0, 		g = 245, 	b = 255},
		{label = _U('mint_green'), 	r = 50, 	g = 255, 	b = 155},
		{label = _U('lime_green'), 	r = 0, 		g = 255, 	b = 0},
		{label = _U('olive'), 			r = 128, 	g = 128, 	b = 0},
