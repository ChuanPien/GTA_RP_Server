...
AddEventHandler("esx_inventoryhud:openPlayerInventory1", function(target, playerName)
    PlayerData = ESX.GetPlayerData()
    targetPlayer = target
    targetPlayerName = playerName
    setPlayerInventoryData()
    openPlayerInventory()
    TriggerServerEvent('esx_inventoryhud:disableTargetInv1', target)
end)
...
function setPlayerInventoryData()
    ESX.TriggerServerCallback("esx_inventoryhud:getPlayerInventory", function(data)
        SendNUIMessage({
            action = "setInfoText",
            text = "<strong>" .. _U("player_inventory") .. "</strong><br>"
        })
