...
AddEventHandler('esx_licenseshop:buyLicenseAircraft', function()
	...
	if xPlayer.getMoney() >= Config.LicenseAircraft then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = '$' .. Config.LicenseAircraft})
	else
...
AddEventHandler('esx_licenseshop:buyLicenseBoating', function()
	...
	if xPlayer.getMoney() >= Config.LicenseBoating then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = '$' .. Config.LicenseBoating})
	else
		TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = '現金不足'})
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseMelee', function()
	...
	if xPlayer.getMoney() >= Config.LicenseMelee then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = '$' .. Config.LicenseMelee})
	else
		TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = '現金不足'})
	end
end)
