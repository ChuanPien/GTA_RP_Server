...
AddEventHandler('esx_customrob:startTimer', function()
	...
	Citizen.CreateThread(function()
		...
		GiveWeaponToPed(merryped7, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped16, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped17, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped18, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped19, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped20, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped21, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped22, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped23, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped24, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped25, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped26, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped27, GetHashKey('weapon_combatpistol'), 250, false, true)
		...
		GiveWeaponToPed(merryped28, GetHashKey('weapon_combatpistol'), 250, false, true)
		TaskCombatPed(merryped28, GetPlayerPed(-1))
		SetPedAccuracy(merryped28, 80)
		SetPedDropsWeaponsWhenDead(merryped28, false)

		merryped29 = CreatePed(30, -1285859404, 607.07, -3079.56, 6.07, 6.00, true, false)
		SetPedArmour(merryped29, 0)
		SetPedAsEnemy(merryped29, true)
		SetPedRelationshipGroupHash(merryped29, 'Merryweather')
		GiveWeaponToPed(merryped29, GetHashKey('weapon_combatpistol'), 250, false, true)
		TaskCombatPed(merryped29, GetPlayerPed(-1))
		SetPedAccuracy(merryped29, 80)
		SetPedDropsWeaponsWhenDead(merryped29, false)

		merryped30 = CreatePed(30, -1285859404, 607.07, -3079.56, 6.07, 6.00, true, false)
		SetPedArmour(merryped30, 0)
		SetPedAsEnemy(merryped30, true)
		SetPedRelationshipGroupHash(merryped30, 'Merryweather')
		GiveWeaponToPed(merryped30, GetHashKey('weapon_combatpistol'), 250, false, true)
		TaskCombatPed(merryped30, GetPlayerPed(-1))
		SetPedAccuracy(merryped30, 80)
		SetPedDropsWeaponsWhenDead(merryped30, false)
	end)
...
Citizen.CreateThread(function()
	while true do
			...
			if distance < Config.Marker.DrawDistance then
				if not holdingUp then
					...
					if distance < 0.5 then
						ESX.ShowHelpNotification('[~g~E~s~]呼叫空投 ~r~$300000')

						if IsControlJustReleased(0, 38) then
							ESX.TriggerServerCallback('esx_customrob:cheakmoney', function(cb)
								if cb then
									TriggerServerEvent('esx_customrob:note')
									...
									TriggerEvent("crateDrop", 'microsmg', tonumber(1), true, 400.0, {["x"] = playerCoords.x, ["y"] = playerCoords.y, ["z"] = playerCoords.z})
								else
									exports['mythic_notify']:DoHudText('error', '黑錢不足')
								end
							end)
						end
					end
		...
		if GetDistanceBetweenCoords(PlyCoords, 479.64, -3370.08, 5.8) > 1 then
			RemoveWeaponFromPed(PlayerPedId(), GetHashKey("weapon_microsmg"), true, true)
		end
