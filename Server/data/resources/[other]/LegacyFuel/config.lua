...
Config.Strings = {
	...
	JerryCanEmpty = "油桶是空的",
	FullTank = "油廂滿了",
	PurchaseJerryCan = "[~g~E~s~]購買油桶將花費~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "[~g~E~s~]停止加油",
	CancelFuelingJerryCan = "[~g~E~s~]停止加油",
	NotEnoughCash = "現金不足",
	RefillJerryCan = "[~g~E~s~]填充油桶花費$",
	NotEnoughCashJerryCan = "現金不足以購買油桶",
	JerryCanFull = "油桶滿了",
	TotalCost = "花費",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "[~g~E~s~]取得油桶"
	Config.Strings.RefillJerryCan = "[~g~E~s~]填充油桶"
end
