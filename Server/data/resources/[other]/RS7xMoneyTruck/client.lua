...
function createped()
    ...
    guard4 =  CreatePedInsideVehicle(vehicle, pedType, hashKey, -1, 1, 1)
  ...
  --///////////
    ...
    SetPedMaxHealth(guard4, 900)
    SetPedAlertness(guard4, 3)
    SetPedCombatRange(guard4, 0)
    SetPedCombatMovement(guard4, 3)
    TaskCombatPed(guard4, GetPlayerPed(-1), 0,16)
    TaskLeaveVehicle(guard4, vehicle, 0)
    GiveWeaponToPed(guard4, GetHashKey("WEAPON_SMG"), 5000, true, true)
