...
Config.webhook = "https://discord.com/api/webhooks/854623269330878474/daVEZ0TnpejI7Xw2xl3aCFQXjYvyG7UUW4NQHzDOUJEyuT_To5V7-gbQomHq8Mwe3YLA"					-- Webhook to send logs to discord
...
Config.contratos = {
	...
	['caminhoes'] = {							-- List of trucks that are generated in contracts
		"man","daf","vnl780","actros","t680","w900"
	},
	['cargas'] = {
		--[[ 
...
Config.trabalhos = {
	...
	['gera_dinheiro_offline'] = true 		-- true: drivers will generate money all the time / false: drivers will generate money only if the owner is online
}
...
Config.blips = {
	{1208.7109375,-3114.9431152344,5.7480750083923,208,1,"貨車公司",0.8 },
}