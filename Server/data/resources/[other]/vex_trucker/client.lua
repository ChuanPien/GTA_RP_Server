...
AddEventHandler('truck_logistics:spawnTruck', function(truck_data)
	...
	truck,truck_blip = spawnVehicle(truck_data.truck_name,x,y,z,h,truck_data.body,truck_data.engine,truck_data.transmission,truck_data.wheels,225,26,Lang[Config.lang]['truck_blip'])
...
AddEventHandler('truck_logistics:startContract', function(data,job_distance,reward,truck_data)
	...
	if data.contract_type == 0 then
		...
		truck,truck_blip = spawnVehicle(data.truck,x,y,z,h,1000,1000,1000,1000,225,26,Lang[Config.lang]['rented_truck_blip'])
		rentTruck = true
	end
	...
	trailer,trailer_blip = spawnVehicle(data.trailer,x,y,z,h,1000,1000,1000,1000,457,26,Lang[Config.lang]['cargo_blip'])
