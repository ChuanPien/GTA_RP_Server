...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/t9FLbT2.png",
...
Config.Languages = {
  ['en'] = {
        ...
        ['propemotes'] = "📦 物件動作",
        ['favoriteemotes'] = "🌟 我的最愛",
        ['favoriteinfo'] = "選擇一個動作設定為我的最愛.",
        ['rfavorite'] = "重設我的最愛",
        ['prop2info'] = "❓ 物件動作可以放在最後再使用",
        ['set'] = "設定 (",
        ['setboundemote'] = ") 成為你的綁定動作?",
        ['newsetemote'] = "~w~ 已經是你的綁定動作,[~g~CapsLock]~w~使用.",
        ['cancelemote'] = "停止動作",
        ['cancelemoteinfo'] = "~r~X~w~停止現在使用的動作",
        ['walkingstyles'] = "走路風格",
        ['resetdef'] = "重設為默認",
        ['normalreset'] = "正常(重設)",
        ['moods'] = "心情",
        ['infoupdate'] = "資訊",
        ['infoupdateav'] = "資訊(可用更新)",
        ['infoupdateavtext'] = "可用更新,獲取最新版本~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "意見建議?",
        ['suggestionsinfo'] = "'在FiveM論壇上的dullpear_dev以獲取任何功能/建議! ✉️",
        ['notvaliddance'] = "不是有效的舞蹈.",
        ['notvalidemote'] = "不是有效的動作.",
        ['nocancel'] = "沒有動作需要停止.",
        ['maleonly'] = "此動作為男性專屬,抱歉!",
        ['emotemenucmd'] = "Do /emotemenu for a menu.",
        ['shareemotes'] = "👫 互動動作",
        ['shareemotesinfo'] = "邀請身邊的人做此動作",
        ['sharedanceemotes'] = "🕺 互動舞蹈",
        ['notvalidsharedemote'] = "不是有效的互動動作.",
        ['sentrequestto'] = "傳出請求~y~",
        ['nobodyclose'] = "~y~沒有人在附近.",
        ['doyouwanna'] = "[~y~Y~w~]接受,[~r~L~w~]拒絕(~g~",
        ['refuseemote'] = "動作拒絕.",
        ['makenearby'] = "讓附近的玩家",
        ['camera'] = "[~y~G~w~]使用閃光燈.",
        ['makeitrain'] = "[~y~G~w~]撒鈔票.",
        ['pee'] = "[~y~G~w~]尿尿.",
        ['spraychamp'] = "[~y~G~w~]噴香檳",
        ['bound'] = "綁定 ",
        ['to'] = "去",
