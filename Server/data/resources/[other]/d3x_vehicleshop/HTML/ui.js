...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">品牌: <b>`+car.categoryLabel+`</b></p>
                                        <p class="card-text">車價: <b>$`+car.price+`</b></p>
                                    </div>
                                    <div class="card-footer bg-white border-0 ">
                                        <button type="button" id="action2" data-value="test-drive" data-model="`+ car.model +`" class="btn btn-success w-auto float-right btn-lg test-drive">試駕</button>
                                    </div>
                                </div>
                            </div>`
                    index++;
    ...
    window.addEventListener('message', function(event) {
        ...
        $('#brand').html(`<option selected value="-1">全部品牌</option>`)
