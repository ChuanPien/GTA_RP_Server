        ...
        if isWithinObject and oElement.fObject ~= 0 then
            ...
            if (distanceDiff < 2.0 and not InUse) then
                if (oElement.fObjectIsBed == true) then
                    ...
                    if (Anim == '坐') then
                        DrawText3Ds(objectCoords.x, objectCoords.y, objectCoords.z, '[~g~E~s~]~g~坐~r~在床上~s~| ' .. Config.Text.SwitchBetween)
                    else
                        DrawText3Ds(objectCoords.x, objectCoords.y, objectCoords.z, '[~g~E~s~]~g~' .. Anim .. '~r~在床上~s~| ' .. Config.Text.SwitchBetween)
                    end
                    ...
                    DrawText3Ds(objectCoords.x, objectCoords.y, objectCoords.z+1, Config.Text.SitOnChair)
