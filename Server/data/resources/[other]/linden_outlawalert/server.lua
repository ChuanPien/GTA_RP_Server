...
function getTitle(src)
	local xPlayer = ESX.GetPlayerFromId(src)
	local title = ('%s %s %s'):format(xPlayer.job.grade_label, xPlayer.get('firstName'), xPlayer.get('lastName'))
	return title
end

local dispatchCodes = {

	melee = { displayCode = '10-10', description = _U('melee'), isImportant = 0, recipientList = {'police','admin'},
	blipSprite = 154, blipColour = 1, blipScale = 1.0 },

	officerdown = {displayCode = '10-99', description = _U('officerdown'), isImportant = 1, recipientList = {'police', 'ambulance','admin'},
	blipSprite = 153, blipColour = 1, blipScale = 1.0, infoM = 'fa-portrait'},

	persondown = {displayCode = '10-52', description = _U('persondown'), isImportant = 0, recipientList = {'police', 'ambulance','admin'},
	blipSprite = 153, blipColour = 1, blipScale = 1.0, infoM = 'fa-portrait'},

	autotheft = {displayCode = '10-16', description = _U('autotheft'), isImportant = 0, recipientList = {'police','admin'},
	blipSprite = 225, blipColour = 1, blipScale = 1.0, infoM = 'fa-car', infoM2 = 'fa-palette' },

	speeding = {displayCode = '10-66', description = _U('speeding'), isImportant = 0, recipientList = {'police','admin'},
	blipSprite = 225, blipColour = 1, blipScale = 1.0, infoM = 'fa-car', infoM2 = 'fa-palette' },

	shooting = { displayCode = '10-13', description = _U('shooting'), isImportant = 0, recipientList = {'police','admin'},
	blipSprite = 156, blipColour = 1, blipScale = 1.0 },

	driveby = { displayCode = '10-13', description = _U('driveby'), isImportant = 0, recipientList = {'police','admin'},
	blipSprite = 229, blipColour = 1, blipScale = 1.0, infoM = 'fa-car', infoM2 = 'fa-palette' },

	holdup = { displayCode = '10-47', description = ('超商警鈴觸發'), isImportant = 1, recipientList = {'police','admin'},
	blipSprite = 154, blipColour = 1, blipScale = 1.0 },

	bank = { displayCode = '10-97', description = ('銀行警鈴觸發'), isImportant = 1, recipientList = {'police','admin'},
	blipSprite = 154, blipColour = 1, blipScale = 1.0 },

	carthief = { displayCode = '10-57', description = ('走私GPS觸發'), isImportant = 1, recipientList = {'police','admin'},
	blipSprite = 154, blipColour = 1, blipScale = 1.0 },

	drugs = { displayCode = '10-38', description = ('市民舉發販毒'), isImportant = 1, recipientList = {'police','admin'},
	blipSprite = 140, blipColour = 1, blipScale = 1.0 },
}
