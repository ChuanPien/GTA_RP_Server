$(function() {
    window.addEventListener('message', function(event) {
        if (event.data.type === "openGeneral"){
            ...
            $('.vb-banking-myaccount-info-address').html('<i class="fal fa-map-marker-alt"></i>&nbsp;&nbsp;&nbsp;</i>地址:&nbsp;&nbsp;'+address+'</span>');
            var walletid = event.data.playerid
            $('.vb-banking-myaccount-info-walletid').html('<i class="fal fa-wallet"></i>&nbsp;&nbsp;&nbsp;</i>帳戶 ID:&nbsp;&nbsp;'+walletid+'</span>');
