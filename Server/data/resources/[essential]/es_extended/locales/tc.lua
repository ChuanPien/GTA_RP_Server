Locales['tc'] = {
  ...
  ['amountammo'] = '子彈量',
  ['noammo'] = '您沒有足夠的子彈！',
  ['gave_item'] = '您把~y~%sx~s~~b~%s~s~給了其他人',
  ['received_item'] = '您收到~y~%sx~s~~b~%s~s~',
  ['gave_weapon'] = '您把~b~%s~s~給予了~y~%s~s~',
  ['gave_weapon_ammo'] = '您把~o~%sx~s~~b~%s~s~ %s~s~給了其他人',
  ['gave_weapon_withammo'] = '您把~b~%s~s~和~o~%sx~s~ %s~s~給了其他人',
  ['gave_weapon_hasalready'] = '~y~%s~s~已經有~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~沒有那把武器',
  ['received_weapon'] = '您收到了~b~%s~s~',
  ['received_weapon_ammo'] = '您收到了~o~%sx~s~ %s~s~(~b~%s~s~)',
  ['received_weapon_withammo'] = '您收到了~b~%s~s~和~o~%sx~s~ %s~s~',
  ['received_weapon_hasalready'] = '某市民嘗試给您~y~%s~s~，但您已经有了',
  ['received_weapon_noweapon'] = '某市民嘗試给您~y~%s~s~子彈，但是您沒有那把武器',
  ['gave_account_money'] = '您將 ~g~$%s~s~ (%s)  給了其他人',
  ['received_account_money'] = '您收到了~g~$%s~s~ (%s)',
