...
ESX.RegisterCommand('j', 'admin', function(xPlayer, args, showError)
...
ESX.RegisterCommand('c', 'admin', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:spawnVehicle', args.car)
end, false, {help = _U('command_car'), validate = false, arguments = {
	{name = 'car', help = _U('command_car_car'), type = 'any'}
}})

ESX.RegisterCommand('d', 'admin', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:deleteVehicle', args.radius)
end, false, {help = _U('command_cardel'), validate = false, arguments = {
	{name = 'radius', help = _U('command_cardel_radius'), type = 'any'}
}})

ESX.RegisterCommand('s$', 'admin', function(xPlayer, args, showError)
...
ESX.RegisterCommand('g$', 'admin', function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
...
ESX.RegisterCommand('i', 'admin', function(xPlayer, args, showError)
...
ESX.RegisterCommand({'clear', 'cls'}, 'admin', function(xPlayer, args, showError)
...
ESX.RegisterCommand('ci', 'admin', function(xPlayer, args, showError)
...
ESX.RegisterCommand('sa', 'admin', function(xPlayer, args, showError)
	ESX.SavePlayers()
